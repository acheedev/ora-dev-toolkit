...
| Module | Score | Reason |
|:---|:---:|:---|
| `src/ansible` | 10 | Full Tower/AWX job lifecycle in PL/SQL — launch, poll, inspect, cancel, status constants, timeout handling. This doesn't exist anywhere else as a packaged solution. Anyone running Oracle + Ansible automation needs exactly this. |
